...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark"
		...
		<div class="container-xl">
			<!-- UDC (reload) 아이콘 -->
			<div>
				<a class="navbar-brand" href="<c:url value='/' />">UDC</a>
			...
			<div class="collapse navbar-collapse" id="navbarsExample07XL">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="../jsp/nList.jsp"
						data-bs-toggle="dropdown" aria-expanded="false">&nbsp;커뮤니티</a>
						<ul class="dropdown-menu">
							<li><a class="dropdown-item" id="dropdown"
								href="/boardList?category=All">전체</a>
							<li><a class="dropdown-item" id="dropdown"
								href="/boardList?category=Q&A">Q&A</a>
							<li><a class="dropdown-item" id="dropdown"
								href="/boardList?category=Review">후기</a>
							<li><a class="dropdown-item" id="dropdown"
								href="/boardList?category=Chat">잡담</a>
						</ul></li>
					<li class="nav-item"><a class="nav-link" href="/FAQ_GET">&nbsp;FAQ</a></li>
				</ul>
			</div>
			<!-- 검색, 로그인, 회원가입 버튼 -->
			<div>
				...
				<c:choose>
					...
					<c:otherwise>
						<button type="button" class="btn btn-outline-light me-2"
							onclick="location.href='/memberLogin'">Login</button>
						<button type="button" class="btn btn-outline-light me-2"
							onclick="location.href='<c:url value='/MemberAgreement'/>'">Sign up</button>

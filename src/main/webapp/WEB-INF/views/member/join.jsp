		...
		<form id="regist" method="post">
			<!-- <div class = "realize">
                ...
                <div class="second_regi">
                    <div class="wrapper">
                        <div class="text">
                            <input class="input1" id="userid" type="text" name="userid" placeholder="영문, 숫자, 특수문자(_)만 사용가능합니다" />
                        </div>
                        <!--
                        <div class="btn_chkId">
                            <input class="chkId" id="btnChkId" type="button" value="아이디 중복 확인" />
                        </div>
                        -->
                ...
                <div class="second_regi">
                    <input class="input1" id="userPwd" type="Password" name="userPwd" maxlength="16" placeholder="16자리 이하만 사용가능합니다">
                </div>
                <div class="first_regi">
                    <p class="p1">비밀번호 확인</p>
                </div>
                <div class="second_regi">
                    <input class="input1" id="userPwd2" type="Password" name="userPwd2" maxlength="16">
                </div>
                <!-- <div class = "realize">
             </div> 유효성 검사 칸-->
                <div class="first_regi">
                ...
                <div class="second_regi">
                    <input class="input1" id="nick" type="text" name="nick" placeholder="영문, 한글만 사용가능합니다">
             ...
             <div class="first_regi">
                 ...
                 <div class="second_regi">
                    <span>
                    <input class="input2" id="email1" type="text" name="email1" > @
                    <input class="input2" id="email2" type="text" name="email2" >
                ...
                <div id="coordXY">
                    ...
                    <input class="input5" type="text" id="sample6_detailAddress" name="locationName" placeholder="상세주소" /><br>
                    <!-- 이거 꼭 눌러야 xy좌표 구함 -->

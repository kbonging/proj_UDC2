		...
		<div class="row mb-2">
			...
			<div class="col-md-6">
				...
				<div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
					<div class="article_card">
						<div class="bg-pic">
							<img src="<c:url value='/img/LESSERAFIM.jpg' />" alt="" aria-hidden="true" />
						</div>
						<div class="inner">
							<div class="header">
							...
							<div class="footer">
								<span class="prix"><a href="cDetail.jsp?concertNo=" style="text-decoration: none; color:white;  text-shadow: 1px 1px 1px black;">LESSERAFIM</a></span>
			...
			<div class="col-md-6">
				...
				<div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
					<div class="article_card">
						<div class="bg-pic">
							<img src="<c:url value='/img/idle.jpg' />" alt="" aria-hidden="true" />
						</div>
						<div class="inner">
							<div class="header">
								<!-- <div class="prix">JOHN MAYER</div> -->
							...
							<div class="footer">
								<span class="prix"><a href="cDetail.jsp?concertNo=" style="text-decoration: none; color:white;  text-shadow: 1px 1px 1px black;">(G)I-DLE</a></span>
								<span class="unit"> <!-- &euro; --></span>
								<div>잠실종합운동장</div>
							</div>
